...
# Include sunbeam root in path for Python to find modules
...
man_pages = [(master_doc, "sunbeam", "Sunbeam Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "Sunbeam",
        "A shotgun sequencing data bioinformatics pipeline",
        "Miscellaneous",
    ),
]
