...
LABEL io.github.snakemake.conda_env_hash="7e142a2e7dcdc02aa01e914e9ad2eef367f6344fed0af72a58e98486dddc5997"

# Step 1: Retrieve conda environments

# Conda environment:
#   source: ../../../envs/annotation.yml
#   prefix: /conda-envs/c441a7aa5d10dcd5e6712ce89adf27a5
#   name: annotation
#   channels:
#     - bioconda
#   dependencies:
#     - prodigal
RUN mkdir -p /conda-envs/c441a7aa5d10dcd5e6712ce89adf27a5
COPY envs/annotation.yml /conda-envs/c441a7aa5d10dcd5e6712ce89adf27a5/environment.yaml
...
RUN mamba env create --prefix /conda-envs/c441a7aa5d10dcd5e6712ce89adf27a5 --file /conda-envs/c441a7aa5d10dcd5e6712ce89adf27a5/environment.yaml && \
